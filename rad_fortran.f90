...
subroutine RADconv(raw,dims,numeric,fNAval,fCLUTTERval)
  implicit none
  integer:: i
...
end subroutine RADconv

! INFO: RX only one Byte 
! NA-Value: 250
! Clutter-Value: 249

subroutine RADconvRX(raw,dims,numeric,fNAval,fCLUTTERval)
  implicit none
  integer:: i
  integer,INTENT(in):: fNAval,fCLUTTERval
  integer,DIMENSION(2),INTENT(in)::dims
